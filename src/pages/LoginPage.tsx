...
export function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (operator && password === 'sentinel2024') {
        ...
        {import.meta.env.DEV && (
          <div className="mt-4 bg-bg-2 border border-border/50 rounded-[4px] p-3">
            ...
            <div className="font-mono text-[9px] text-text-3 space-y-1">
              <div>operator@sentinel.ops / sentinel2024</div>
              <div>analyst@sentinel.ops / sentinel2024</div>
              <div>admin@sentinel.ops / sentinel2024</div>
            </div>
          </div>
        )}
      </div>
